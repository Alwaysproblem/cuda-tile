...
float data1[] = {16, 86, 31, 96, 6, 39, 79, 11, 100, 117, 118, 37, 106, 128, 11,
                 13, 43, 111, 104, 64, 22, 111, 106, 112, 0, 102, 41, 80, 46, 64,
...
int main() {
  ...
  // Launch the kernel.
  void *kernel_args[] = {&data_ptr, &data_ptr1, &out_ptr};
  CUDA_CHECK(cuLaunchKernel(example_kernel, // function
                            16, 1, 1,        // grid dims: must be (1,1,1)
                            1, 1, 1,        // block dims
  ...
  float host_out[sizeof(data) / sizeof(float)];
